      ...
      <div className="relative z-10 w-full px-4 pb-4 max-w-md mx-auto">
        ...
        <div className="frosted-paper rounded-[32px] p-8 shadow-[0_4px_20px_rgba(204,90,61,0.08)] w-full">
          ...
          <form className="space-y-4" onSubmit={handleLogin}>
            ...
            <button type="submit" disabled={submitting} className="warm-glow-gradient w-full h-14 rounded-2xl text-white font-label-md shadow-lg active:scale-95 transition-all duration-150 mt-4 text-base tracking-wide font-bold disabled:opacity-60">
          ...
          <div className="mt-8 text-center">
            <p className="text-body-md font-body-md text-on-surface-variant text-sm">
              还没有账号？{' '}
              <button type="button" onClick={() => router.push('/register')} className="text-primary font-bold hover:underline decoration-2 underline-offset-4 cursor-pointer">
                立即注册
              </button>
            </p>
          </div>
