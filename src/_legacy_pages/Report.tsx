...
export default function Report() {
  ...
  return (
    <div className="px-margin-mobile pt-4 pb-20 overflow-y-auto relative h-full">
      <div className="flex overflow-x-auto space-x-3 mb-8 hide-scrollbar -mx-margin-mobile px-margin-mobile">
      ...
      <div className="grid grid-cols-1 gap-6">
        {reports.map(report => (
          <div key={report.id} onClick={() => navigate(`/reports/${report.id}`)} className="bg-surface-container-lowest rounded-3xl overflow-hidden shadow-[0_4px_20px_rgba(204,90,61,0.08)] hover:scale-[1.02] transition-transform duration-300 relative border border-surface-container/50 cursor-pointer">
          ...
          <div className="flex-1 overflow-y-auto p-margin-mobile space-y-6 pb-8">
            ...
            <div>
              ...
              <div className="w-full h-40 bg-surface-container-low rounded-2xl border-2 border-dashed border-outline-variant/50 flex flex-col items-center justify-center text-outline-variant">
                ...
                <span className="text-sm font-label-md">当前 demo 使用默认图片，后续可接 Supabase Storage</span>
              </div>
            </div>
