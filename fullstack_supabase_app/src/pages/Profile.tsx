...
export default function Profile() {
  ...
  return (
    <div className="px-margin-mobile pt-4 pb-12 overflow-y-auto">
      {/* Profile Header */}
      <section className="flex flex-col items-center text-center mb-8">
        ...
        <h2 className="font-headline-md text-headline-md text-on-surface mb-1">{user?.name || 'Guest'}</h2>
        <p className="font-label-md text-label-md text-on-surface-variant mb-6">加入时间: 2023年5月</p>
      ...
      {savedPets.length > 0 && (
        <section className="mb-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            {savedPets.map(pet => (
              <div key={pet.id} onClick={() => navigate(`/pets/${pet.id}`)} className="bg-surface-container-lowest rounded-[24px] overflow-hidden shadow-[0_4px_20px_rgba(204,90,61,0.08)] hover:scale-[1.02] transition-transform duration-200 cursor-pointer">
